...
const services = [
  {
    ...
    description:
      "Tramitación de divorcio de mutuo acuerdo o unilateral. Asesoría completa en separación judicial y de hecho en Chile.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Demanda, aumento, rebaja o cese de pensión alimenticia. Calculamos el monto justo según la ley chilena.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Cuidado Personal de Hijos",
    description:
      "Demanda de cuidado personal (tuición). Protegemos el interés superior del niño en tribunales de familia.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Regulación de relación directa y regular con los hijos. Fijamos un calendario justo y protector.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Medidas de protección urgentes y órdenes de alejamiento por VIF. Actuamos rápidamente para tu seguridad.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    title: "Adopción",
    description:
      "Acompañamiento legal completo en el proceso de adopción en Chile. Trámites ante el SENAME y tribunales.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Mediación como requisito previo obligatorio. Te acompañamos en el proceso para alcanzar acuerdos justos.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "División de bienes tras el divorcio. Liquidamos la sociedad conyugal protegiendo tu patrimonio.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Celebración y término de acuerdos de unión civil (AUC). Asesoría en derechos y obligaciones legales.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Demanda de filiación y reconocimiento de paternidad. Pruebas de ADN y trámites judiciales.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Atendemos todas las materias de Derecho de Familia en Chile con
