...
export default function Contact() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    setStatus("sending");
    try {
      // El registro en la planilla usa modo no-cors (respuesta opaca): un
      // fallo de red sí rechaza la promesa, así que lo capturamos para no
      // mostrar un falso "enviado" y ofrecer WhatsApp como alternativa.
            ...
            {status === "sent" ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-blue-200 mb-6">
                  Tuvimos un problema de conexión. Escríbenos directo por
                  WhatsApp y te respondemos igual de rápido.
                </p>
                <a
                  href={WHATSAPP_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-bold px-7 py-3.5 rounded-full transition-all hover:scale-105 shadow-lg shadow-green-500/30"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <button
                  ...
                  className="block mx-auto mt-4 text-sm text-blue-200/60 hover:text-blue-200 underline"
                >
                  Intentar de nuevo
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex items-start gap-3">
                  <input
                    ...
                    type="checkbox"
                    required
                    className="mt-1 h-4 w-4 shrink-0 rounded border-white/30 bg-white/10 accent-accent focus:ring-2 focus:ring-accent/60"
                  />
                  <label
                    htmlFor="consentimiento"
                    className="text-sm text-blue-100/80 leading-relaxed"
                  >
                    ...
                    y autorizo el tratamiento de mis datos para responder mi
                    consulta.
                  </label>
                </div>
                ...
                <button
                  ...
                  className="w-full bg-accent hover:bg-accent-dark text-primary font-bold text-lg py-4 rounded-lg transition-all hover:shadow-lg hover:shadow-accent/20 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {status === "sending" ? "Enviando..." : "Enviar Consulta Gratuita"}
                </button>
